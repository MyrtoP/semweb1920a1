...
with open('programm1.csv', 'r', newline='', encoding='utf-8') as ifp, open('programm2.csv', 'w', newline='', encoding='utf-8')as ofp:
    ...
    for i in ir:
        s = i[0]
        # kolame mposta to uri
        # tin 2 stili tin pername apo tis parapano sinartiseis
        p = ('http://host/p16papa3/vocabulary#' + i[1])
        ...
        if i[1] != 'ΕΝΑΡΞΗ' and i[1] != 'ΛΗΞΗ' and i[1] != 'ΗΜΕΡΑ':
            # kolame mposta to uri
            o = ('http://host/p16papa3/resource/' + i[2])
